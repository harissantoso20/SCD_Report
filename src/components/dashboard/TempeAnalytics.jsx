  ...
  const renderAIInsight = () => {
    ...
    return (
      <div className="text-slate-600 font-medium leading-relaxed text-[13px] space-y-3">
        ...
        <p>
          Jika dikomparasikan secara *Year-on-Year* (YoY), {prevYearOmzet > 0 ? (tempeYTD.total_omzet > prevYearOmzet ? "performa komersial mencatat pertumbuhan positif dibandingkan tahun sebelumnya" : "terjadi kontraksi pendapatan") : "belum ada data historis yang memadai untuk menghitung pertumbuhan komersial secara akurat"}. Di sisi lain, harga jual Olahan Tempe (rata-rata {new Intl.NumberFormat('id-ID').format(avgPriceOlahan)}/Kg) terbukti jauh lebih tinggi dibandingkan harga Mentah (rata-rata {new Intl.NumberFormat('id-ID').format(avgPriceMentah)}/Kg).
        </p>
  ...
  return (
    <div className="w-full flex flex-col gap-4 font-sans text-slate-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-4 md:p-5 rounded-lg shadow-sm border border-slate-200 border-t-4 border-t-blue-600 hover:-translate-y-1 hover:shadow-md transition-all duration-300 flex items-start gap-4 relative overflow-hidden group">
          ...
          <div className="flex flex-col mb-1 relative z-10">
            ...
            <span className="text-lg xl:text-xl tracking-tight font-extrabold text-[#1e3a8a]">{formatRupiah(tempeYTD.total_omzet)}</span>
          </div>
          {/* Doodle Art */}
        ...
        <div className="bg-white p-4 md:p-5 rounded-lg shadow-sm border border-slate-200 border-t-4 border-t-blue-400 hover:-translate-y-1 hover:shadow-md transition-all duration-300 flex items-start gap-4 relative overflow-hidden group">
          ...
          <div className="flex flex-col mb-1 relative z-10">
            ...
            <span className="text-lg xl:text-xl tracking-tight font-extrabold text-[#1e3a8a]">{new Intl.NumberFormat('id-ID').format(tempeYTD.total_qty_mentah)} <span className="text-sm font-semibold text-slate-400">Kg</span></span>
          </div>
          {/* Doodle Art */}
        ...
        <div className="bg-white p-4 md:p-5 rounded-lg shadow-sm border border-slate-200 border-t-4 border-t-blue-900 hover:-translate-y-1 hover:shadow-md transition-all duration-300 flex items-start gap-4 relative overflow-hidden group">
          ...
          <div className="flex flex-col mb-1 relative z-10">
            ...
            <span className="text-lg xl:text-xl tracking-tight font-extrabold text-[#1e3a8a]">{new Intl.NumberFormat('id-ID').format(tempeYTD.total_qty_olahan)} <span className="text-sm font-semibold text-slate-400">Kg</span></span>
          </div>
          {/* Doodle Art */}
      ...
      <div className="flex flex-col min-h-[300px]">
        <GeminiInsight 
          programName="Produksi Rumah Tempe"
